...
//  LSR
//
//  Created by Mahesh Dhakad on 9/19/14.
...
- (void)layoutSubviews {
    ...
    CGSize labelSize =[label.text boundingRectWithSize:CGSizeMake(label.frame.size.width,label.frame.size.height) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName :label.font}context:nil].size;
    ...
    CGSize detailsLabelSize =[detailsLabel.text boundingRectWithSize:CGSizeMake(detailsLabel.frame.size.width,detailsLabel.frame.size.height) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName :detailsLabel.font}context:nil].size;
